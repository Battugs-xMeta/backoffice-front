...
export const Info = ({}) => {
  ...
  const debouncedChoisenWorkers = debounce((value) => {
    choisonCentersEmployes.run({
      query: value,
      car_center_id: choisenCareCenter,
    });
  }, 1000);
          ...
          {(form) => {
            return (
              <>
                ...
                />
                {form.getFieldValue("movement_type") === 11 && (
                  ...
                  <>
                    <ProFormSelect
                      ...
                      fieldProps={{
                        ...
                        onChange: (value: number, optionLabelProp) => {
                          choisonCentersEmployes.run({ car_center_id: value });
                          setChoisenCareCenter(value);
                        },
                      }}
                      required
                      placeholder="Сонгох"
                      options={allCareCenters?.data?.reduce<SelectOption[]>(
                        (acc, record) => {
                          acc.push({
                            label: (
                              <div className="flex gap-2 items-center">
                    ...
                    <ProFormSelect
                      ...
                      fieldProps={{
                        showSearch: true,
                        loading: choisonCentersEmployes.loading,
                        filterOption: false,
                ...
                {form.getFieldValue("movement_type") === 12 && (
                ...
                {form.getFieldValue("movement_type") === 13 && (
                              ...
                              [
                                {
                                  pattern: /^[1-9]{1}[0-9]{7}$/g,
                                  message:
                                    "Энэ талбар утасны дугаар байх ёстой",
                                },
                              ])
                            }
                          />
                ...
                {form.getFieldValue("movement_type") === 14 && (
                  ...
                  <>
                    ...
                    <Row gutter={[24, 24]}>
                      <Col span={12}>
                        <ProFormText
                          name={["charity_work", "company_name"]}
