...
import { atomTransictionForceForm } from "utils/store";
...
const Force = () => {
  const [form, setForm] = useAtom(atomTransictionForceForm);
  ...
  const run = () => {
    list.run({
      ...form,
      query: search,
      movement_type: MovementStatusEnum.force, // Албапан гаргасан үед movement type Ийг 13 болгож хүсэлт дуудна
    });
  };
          ...
          <InitTableHeader
            ...
            setSearch={(e) => {
              ...
              searchRun.run({
                ...form,
                query: e,
                movement_type: MovementStatusEnum.force,
              });
            }}
            customHeaderTitle="Албадан гаргасан үйлчлүүлэгчдийн жагсаалт"
            ...
            toolbarItems={
              <div className="flex">
                <ExportButton
                  onClick={() => {
                    exportFromTable(
                      ["Албадан гаргасан үйлчлүүлэгчдийн жагсаалт"],
